...
Sample Plugin is a special plugin created by BJm Digital for added CPT cards functionality. Looking for more text here!
...
= 1.0.3 =
* removed a composer dependency to check the auto update
...
* Fix: Sample Plugin block controls for spacing and visibility only to core, acf and blokki block types
